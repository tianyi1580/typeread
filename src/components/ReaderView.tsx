...
import { SatinHeartParticles } from "./SatinHeartBackground";
    ...
    <>
      <div
        className={cn(
          ...
          settings.theme === "nebula-drift" || settings.theme === "satin-heart" || settings.theme === "everfrost-silence"
      ...
      >
        ...
        {settings.theme === "nebula-drift" && (
          <div className="absolute inset-0 z-0 pointer-events-none">
            <CelestialParticles count={70} size={2} opacity={0.65} speed={120} twinkle />
          </div>
        )}
        ...
        {/* Subtle Heart Swarm for Satin Heart Theme */}
        {settings.theme === "satin-heart" && (
          <div className="absolute inset-0 z-0 pointer-events-none">
            <SatinHeartParticles isSubtle opacity={0.9} />
          </div>
        )}
            ...
            <div className={cn(
              ...
              <div
                ...
                className={cn(
                  ...
                  settings.theme === "rainy-window" || settings.theme === "satin-heart" || settings.theme === "everfrost-silence"
                    ? "liquid-glass-soft"
                    : cn(
  ...
  return (
    <div
      className={cn(
        ...
        style.theme === "rainy-window" || style.theme === "satin-heart" || style.theme === "everfrost-silence"
          ? "liquid-glass-soft"
          : cn(
