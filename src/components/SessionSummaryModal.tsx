...
export function SessionSummaryModal({ summary, onClose, onRestart }: SessionSummaryModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-[rgba(6,8,14,0.7)] px-4 py-6 backdrop-blur-xl animate-in fade-in">
      ...
      <Card className="relative w-full max-w-3xl border-white/10 bg-[color-mix(in_srgb,var(--panel)_82%,transparent)] p-8 shadow-[0_32px_120px_rgba(0,0,0,0.5)] backdrop-blur-3xl md:p-12 animate-in max-h-[90vh] overflow-y-auto">
        <div className="space-y-10">
          ...
          <div className="flex flex-col items-center justify-between gap-8 border-t border-[var(--border)] pt-10 sm:flex-row">
            ...
            <div className="flex w-full flex-col gap-3 sm:w-auto">
              ...
              {onRestart && (
                <Button variant="ghost" onClick={onRestart} className="py-6 text-base">
                  Start New Test
                </Button>
              )}
            </div>
