  ...
  return (
    ...
    >
      ...
      >
        ...
        <main className={cn("relative", activeTab === "reader" ? "flex h-full flex-col overflow-hidden" : (showWindowShell || readerMode === "scroll" ? "mx-auto mt-5 max-w-[1480px]" : "flex h-full flex-col overflow-hidden"))}>
          {activeTab === "library" && (
            <LibraryView
              books={filteredBooks}
